...
- คอนเทนต์เนื้อหาใน Marketplace/My Content (เนื้อหาของฉัน) ไม่แสดงผล (ยกเว้น Realms Plus) ซึ่งเป็นบักของเกม Minecraft วิธีแก้ไขให้เปลี่ยนกลับไปภาษาดั้งเดิมของตัวเกมก่อน
