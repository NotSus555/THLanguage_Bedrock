...
คุณสามารถดาวน์โหลดรีซอร์ซแพ็กต้นฉบับของทางเป็ดล่าสุดได้จากหน้า [Releases](https://github.com/MineGarp-PED/THLanguage_Bedrock/releases) ของเรา

ส่วนของทางนี้จะอัพเดทตามให้ไวที่สุดที่ทำได้ดาวน์โหลดได้ที่ [Releases](https://github.com/NotSus555/THLanguage_Bedrock/releases)
